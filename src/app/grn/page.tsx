  ...
  return (
    <div className="flex flex-1 flex-col gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Track chain-of-custody records, invoices and material received dates.
          </p>
        </div>
        {can(user, "importGrn") && (
          <ModuleBulkUpload
            apiPath="/api/grns/import"
            title="Bulk Upload Chain of Custody"
            description="Import chain-of-custody records from a CSV or Excel file."
      ...
      <ModuleTable
        ...
        attach={{ module: "grn", title: "Chain of Custody" }}
      />
    </div>
  );
}